...
import FootballContractJustCause from "./content/knowledge/Football-Contract-Just-Cause";
...
const App: React.FC = () => {
  ...
  <Route path="/knowledge/Football-Contract-Just-Cause" element={<FootballContractJustCause />} />
