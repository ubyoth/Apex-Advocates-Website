          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-12">
                Apex Advocates & Solicitors is located in Lagos, Nigeria providing easy access to corporate clients and individuals
                across Nigeria.
              </p>
            ...
            <div className="bg-black/5 dark:bg-secondary-grey/20 rounded-3xl p-10 border border-accent-gold/10 relative overflow-hidden">
              <h3 className="text-xl font-bold text-black dark:text-white mb-8 border-l-4 border-accent-gold pl-4 uppercase tracking-widest text-xs">
                Office Hours
              </h3>
